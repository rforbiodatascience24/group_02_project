    ...
    <li class="fragment">Progression plots</li>
      <ul>
        ...
        <img 
          ...
          alt="Overall world progression of vaccinations (all types)">
        <img 
          src="../results/world_plot_2020_12_31.jpeg" 
          class="fragment" 
          style="width: 100%; position: absolute; top: 10%; left: 0.5%;" 
          alt="Overall world progression of vaccinations (all types)">
        <img 
          src="../results/world_plot_2021_05_13.jpeg" 
          class="fragment" 
          style="width: 100%; position: absolute; top: 10%; left: 0.5%;" 
          alt="Overall world progression of vaccinations (all types)">
        <img 
          src="../results/world_plot_2022_03_25.jpeg" 
          class="fragment" 
          style="width: 100%; position: absolute; top: 10%; left: 0.5%;" 
          alt="Overall world progression of vaccinations (all types)">
        <img 
          src="../results/whole_world_plot_2022_03_25.jpeg" 
          class="fragment" 
          style="width: 100%; position: absolute; top: 10%; left: 0.5%;" 
          alt="Overall world progression of vaccinations (all types)">
      </ul>
