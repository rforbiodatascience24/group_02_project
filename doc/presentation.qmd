  ...
  <ul>
    ...
    <li class="fragment">Progression plots</li>
      <ul>
        ...
        <img src="../result/vaccine_progression.png" class="fragment" style="width: 80%; margin: auto;" alt="Overall world progression of vaccinations (all types)">
      </ul>
  </ul>
</section>

tekst tekst 
[Overall world progression of vaccinations](../result/vaccine_progression.png){width=80%}
