...
# And their populations in 2021 in mio
...
```{r}
# Finding total of vaccinated people pr country
...
```{r}
# Joining two data sets based on location
...
```{r}
# Calculating percentage of vaccinated pr country
